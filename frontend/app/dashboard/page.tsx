...
export default async function DashboardPage() {
  ...
  const recentHint = listResult.ok
    ...
    : listResult.reason === "no_token"
      ? "No API access token in session."
      : listResult.reason === "no_tenant"
        ? "Set TENANT_ID to load live service requests."
        : "Could not load service requests from the API.";
  return (
    <>
        ...
        <div className="rounded-xl border border-gray-100 bg-white p-6 lg:col-span-3">
          ...
          {recentHint ? (
            ...
            <p className="mb-4 text-xs text-gray-400">
              Up to five most recent items for the configured tenant.
            </p>
          )}
              ...
              >
                <div>
                  ...
                  <div className="mt-1 flex items-center text-xs text-gray-500">
                    ...
                    {row.channelLabel ?? "—"} · updated {row.updatedLabel}
                  </div>
                </div>
